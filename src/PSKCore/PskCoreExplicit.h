...
typedef long (__stdcall FNSTARTSOUNDCARDEX)(HWND h_Wnd, long cardnum, long numRXchannels, long IOMode);
...
typedef long (__stdcall FNSETINPUTWAVEPATH(char* path, long* pLengthTime, long Offset);
typedef long (__stdcall FNSETOUTPUTWAVEPATH(char* path, long TimeLimit, long Append);

/////////////////////////////////////////////////////////////////
//  Functions added after the initial release
/////////////////////////////////////////////////////////////////
typedef void (__stdcall FNREWINDINPUT)(long Blocks);
typedef void (__stdcall FNSETINPUTWAVEPATH)(char* path, long* pLengthTime, long Offset);
typedef void (__stdcall FNSETOUTPUTWAVEPATH)(char* path, long TimeLimit, long Append);
typedef void (__stdcall FNSTARTSOUNDCARDEX)(HWND h_Wnd, long cardnum, long numRXchannels, long IOMode);
typedef long (__stdcall FNENABLERXCHANNEL)(long chan, long enable);
typedef long (__stdcall FNISRXCHANNELACTIVE)(long chan);
typedef long (__stdcall FNGETNUMACTIVERXCHANNELS)();
